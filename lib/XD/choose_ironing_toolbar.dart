...
import 'package:get_tidy/XD/checkout_profile.dart';
import 'package:get_tidy/XD/componentbookdryservice.dart';
import 'package:get_tidy/XD/choose_ironing.dart';

class ChooseIroningBottomBar extends StatelessWidget {
  String userNameSurname = 'Zeynep Hanim';
  String userAvatar = 'assets/drawable-xxxhdpi/avatar-woman.png';
  String userRating = '4.3';
  ChooseIroningBottomBar({Key? key, required this.userAvatar, required this.userNameSurname, required this.userRating})
      : super(key: key);
  @override
        ...
        children: <Widget>[
          Stack(
            children: <Widget>[
              ...
              // TEXT OF NAME AND SURNAME OF USER
              Pinned.fromPins(
              ...
              // icon chat
              GestureDetector(
                onTap: () => Get.snackbar('Chat', 'tapped'),
                child: Pinned.fromPins(
                  Pin(size: 47.0, middle: 0.75),
                  Pin(size: 47.0, end: 125.0),
                  child: Image.asset('assets/drawable-xxxhdpi/icon_chat.png'),
                ),
              ),
              //TEXT OF CHAT
              Pinned.fromPins(
                Pin(size: 33.0, middle: 0.75),
                Pin(size: 17.0, end: 111.0),
                child: Text(
                  'Chat',
                  style: TextStyle(
              ...
              // icon more
              GestureDetector(
                onTap: () => Get.snackbar('More', 'tapped'),
                child: Pinned.fromPins(
                  Pin(size: 47.0, middle: 0.95),
                  Pin(size: 47.0, end: 125.0),
                  child: Image.asset('assets/drawable-xxxhdpi/icon-more.png'),
                ),
              ),
              // TEXT OF MORE
              Pinned.fromPins(
                Pin(size: 38.0, end: 21.0),
                Pin(size: 17.0, end: 111),
                child: Text(
                  'More',
                  style: TextStyle(
                    fontFamily: 'Poppins',
