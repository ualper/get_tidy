...
import 'package:get_tidy/firebase_auth/screens/profile_page.dart';
import 'package:get_tidy/firebase_auth/screens/register_page.dart';
                                  ...
                                  children: [
                                    Expanded(
                                      child: ElevatedButton(
                                        onPressed: () async {
                                          Get.snackbar(_emailTextController.text, _passwordTextController.text);
                                          _focusEmail.unfocus();
                                          _focusPassword.unfocus();
